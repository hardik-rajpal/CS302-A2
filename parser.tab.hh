...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy7[sizeof (op_binary_astnode*)];
      ...
      // selection_statement
      // iteration_statement
      char dummy8[sizeof (statement_astnode*)];
      ...
      // program
      // translation_unit
      char dummy10[sizeof (std::vector<abstract_astnode*>)];

      // expression_list
      char dummy11[sizeof (std::vector<exp_astnode*>)];

      // compound_statement
      // statement_list
      char dummy12[sizeof (std::vector<statement_astnode*>)];

      // parameter_list
      char dummy13[sizeof (std::vector<typespec_astnode>)];
      ...
      // declaration
      // declarator_list
      char dummy14[sizeof (typespec_astnode)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_begin_nterm = 47,                      // begin_nterm
        S_48_1 = 48,                             // $@1
        S_program = 49,                          // program
        S_main_definition = 50,                  // main_definition
        S_51_2 = 51,                             // $@2
        S_translation_unit = 52,                 // translation_unit
        S_struct_specifier = 53,                 // struct_specifier
        S_54_3 = 54,                             // $@3
        S_function_definition = 55,              // function_definition
        S_type_specifier = 56,                   // type_specifier
        S_fun_declarator = 57,                   // fun_declarator
        S_58_4 = 58,                             // $@4
        S_parameter_list = 59,                   // parameter_list
        S_parameter_declaration = 60,            // parameter_declaration
        S_declarator_arr = 61,                   // declarator_arr
        S_declarator = 62,                       // declarator
        S_compound_statement = 63,               // compound_statement
        S_statement_list = 64,                   // statement_list
        S_statement = 65,                        // statement
        S_printf_call = 66,                      // printf_call
        ...
        S_mnterm = 71,                           // mnterm
        S_ifgotocoder = 72,                      // ifgotocoder
        S_logical_and_expression = 73,           // logical_and_expression
        S_equality_expression = 74,              // equality_expression
        S_relational_expression = 75,            // relational_expression
        S_additive_expression = 76,              // additive_expression
        S_unary_expression = 77,                 // unary_expression
        S_multiplicative_expression = 78,        // multiplicative_expression
        S_postfix_expression = 79,               // postfix_expression
        S_primary_expression = 80,               // primary_expression
        S_expression_list = 81,                  // expression_list
        S_unary_operator = 82,                   // unary_operator
        S_selection_statement = 83,              // selection_statement
        S_84_5 = 84,                             // $@5
        S_85_6 = 85,                             // $@6
        S_86_7 = 86,                             // $@7
        S_87_8 = 87,                             // $@8
        S_iteration_statement = 88,              // iteration_statement
        S_89_9 = 89,                             // $@9
        S_90_10 = 90,                            // $@10
        S_91_11 = 91,                            // $@11
        S_92_12 = 92,                            // $@12
        ...
        S_95_15 = 95,                            // $@15
        S_96_16 = 96,                            // $@16
        S_declaration_list = 97,                 // declaration_list
        S_declaration = 98,                      // declaration
        S_declarator_list = 99                   // declarator_list
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_mnterm: // mnterm
        value.move< mnt* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, mnt*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const mnt*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
